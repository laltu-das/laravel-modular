...
final readonly class LaravelModular
{
    ...
    public function modules(): array { return $this->modules->all(); }
    public function module(string $name): Module { return $this->modules->find($name) ?? throw new ModuleNotFound("Module [{$name}] does not exist."); }
